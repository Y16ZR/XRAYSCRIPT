...
echo ""
echo -e "         \e[0;94mXRAY-CORE : $xray       \e[0;94mSHADOWSOCKS OBFS : $ss"
echo -e "       $green——————————$blue———————————————$cyan————————————$yellow—————————――$NC"
echo -e "  \e[0;34m┏━━━━━━━━━━━━━━━━[ \e[0;33mCONTROLL PANEL MENU\e[m \e[0;34m]━━━━━━━━━━━━━━━━━━━┓"
echo -e "  \e[0;34m┃                                                          ┃"
echo -e "      $green[${white}•1${green}] ${white}XRAY WIREGUARD$NC       $green[${white}•5${green}] ${white}XRAY VMESS/VLESS WS$NC"
echo -e "      $green[${white}•2${green}] ${white}XRAY VLESS XHTTP$NC     $green[${white}•6${green}] ${white}XRAY VLESS TCP XTLS$NC"
echo -e "      $green[${white}•3${green}] ${white}SHADOWSOCKS OBFS$NC     $green[${white}•7${green}] ${white}XRAY TROJAN WEBSOCKET$NC"
echo -e "      $green[${white}•4${green}] ${white}XRAY SHADOWSOCKS$NC     $green[${white}•8${green}] ${white}XRAY TROJAN GRPC TLS$NC"
echo -e "  \e[0;34m┃                                                          ┃"
echo -e "  \e[0;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"
...
echo -e "  \e[0;34m┃$NC$green[${white}19${green}] ${white}CLEAR-LOG & CACHE         \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}20${green}] ${white}SHOW SERVER BANDWITH      \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}21${green}] ${white}CHANGE PASSWORD VPS       \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}22${green}] ${white}SHOW SPEEDTEST SERVER     \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}23${green}] ${white}UPDATE XRAY CORE          \e[0;34m┃$NC                          \e[0;34m┃$NC"
